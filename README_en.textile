...
RisingGuilds is a webbased system for WorldOfWarcraft-Guilds on the private server 'rising-gods.de'. Therefor it is designed to work with the RG-XML-Armory, but may be used with the Blizzard-Armory with some changes. The opensource project is realized by a small team of developers.
...
A detailed instruction for the installation on -windows- or linux can be found in our wiki.
